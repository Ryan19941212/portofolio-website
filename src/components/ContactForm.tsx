      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="tech-label text-nv-500">CONTACT / 06</span>
          </div>
          ...
          <p className="text-base md:text-lg text-ink-300 max-w-2xl">
            ...
            hear about it. Usually responds within 24 hours.
          </p>
        </motion.div>
          ...
          {contactMethods.map((m, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="tech-label-sm text-nv-500">{m.label}</span>
              </div>
