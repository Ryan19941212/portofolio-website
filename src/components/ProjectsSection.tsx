                ...
                <div className="lg:col-span-6 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2.5 py-1 font-mono text-[10px] uppercase tracking-wider border border-white/10 text-ink-300"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 self-start border border-white/15 hover:border-nv-500 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.18em] text-ink-200 hover:text-nv-500 transition-colors"
                    >
