      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-10 py-16 lg:py-24">
        <div className="grid grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 relative">
            ...
            >
              <div className="tech-label-sm mb-4 text-ink-300">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl text-white leading-[1.25] max-w-2xl mb-5 font-display font-medium">
                I build the robots <span className="text-nv-500">I ship specs for.</span>
              </p>
              <p className="text-lg md:text-xl text-ink-200 leading-relaxed max-w-xl mb-8">
              ...
              <div className="mb-10 border border-white/10 bg-ink-900/60 relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-px bg-white/5">
                  ...
                  <div className="bg-ink-900 p-4">
                    <div className="tech-label-sm mb-2">TARGET</div>
                    <div className="text-white text-sm font-medium leading-snug">
                      Robotics / Autonomy PM
                    </div>
                    <div className="font-mono text-[12px] text-ink-400 mt-1">
                      Summer 2026 · FT 2027
                    </div>
                  ...
                  <a
                    href="#resume"
                    className="group bg-ink-900 p-4 hover:bg-nv-500 hover:text-ink-950 transition-colors block"
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <motion.a
                  href="#roboracer"
                  className="group inline-flex items-center justify-center gap-3 px-6 py-4 bg-nv-500 text-ink-950 font-mono text-xs uppercase tracking-[0.2em] font-semibold hover:bg-nv-400 transition-colors"
                  whileHover={{ x: 2 }}
                  whileTap={{ scale: 0.98 }}
                >
          ...
          {/* Right: Featured asset — RoboRacer hero iframe */}
          <div className="col-span-12 lg:col-span-5">
            ...
            >
              <div className="absolute -top-3 left-4 z-10 px-2 bg-ink-950">
                <span className="tech-label-sm text-nv-500">● LIVE FEED / ROBORACER</span>
              </div>
              ...
              <div className="border-t border-white/10 px-4 py-3 grid grid-cols-3 gap-2 font-mono text-[12px]">
                <div>
                  ...
                  <div className="text-white mt-1">GAP_FOLLOW</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-nv-500 mt-1">NOMINAL</div>
                </div>
              </div>
            </motion.div>
