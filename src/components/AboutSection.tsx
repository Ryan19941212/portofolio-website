  ...
  return (
    <section id="about" className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-8">
            About Me
          </h2>

          <motion.div
            className="relative bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12 shadow-2xl overflow-hidden group"
          ...
          >
            ...
            <motion.p
              className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 relative z-10"
              initial={{ opacity: 0 }}
            ...
            <motion.a
              href="#resume"
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-xl font-medium text-lg relative z-10 overflow-hidden group/button"
